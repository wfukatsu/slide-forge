...
[slide-patterns.ja.md](slide-patterns.ja.md)、図表部品の詳細は
[patterns.ja.md](patterns.ja.md) / [charts.ja.md](charts.ja.md) / [diagrams.ja.md](diagrams.ja.md) にある。
...
標準は骨格B（左図＋右示唆）。座標は [slide-patterns.ja.md](slide-patterns.ja.md) の「骨格の標準座標」にそのまま使える値がある。
