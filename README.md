...
slide-templates/ reusable single-slide content templates + registry (99 in 14 packs; manifest.json)
...
`slide-templates/` holds 99 ready-made one-page templates in fourteen packs. A
...
Beyond these page patterns, `slide-templates/` registers 99 ready-made
