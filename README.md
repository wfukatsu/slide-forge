...
slide-templates/ reusable single-slide content templates + registry (95 in 14 packs; manifest.json)
...
`slide-templates/` holds 95 ready-made one-page templates in fourteen packs. A
...
Beyond these page patterns, `slide-templates/` registers 95 ready-made
